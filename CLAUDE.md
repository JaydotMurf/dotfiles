...
**Git identity switching**: Default identity is work (`Jerraill.Murphy@gdit.com`). The personal identity (`jerraill.openclaw@gmail.com`) is loaded automatically via `includeIf "gitdir:~/dev/personal/openclaw/"` — no manual switching needed.
